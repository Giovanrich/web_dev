  ...
  <body onload="loadData()">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
           <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="comments.php"><i class="fa fa-envelope" aria-hidden="true"></i> Messages</a></li>
    ...
    <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1 id="heading"><i class="fa fa-envelope" aria-hidden="true"></i> Messages <small>Manage Your Site Messages.</small></h1>
          </div>
          <div class="col-md-2">
          ...
          <!--Site overwiew-->
            <div class="panel panel-default ">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Messages from Visitors</h3>
              </div>
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-10">
                        <div class="tip left">
                          ...
                          Nullam consectetur quam a sapien egestas eget scelerisque lectus tempor.
                          Duis placerat tellus at erat pellentesque nec ultricies erat molestie.
                          Integer nec orci id tortor molestie porta. Suspendisse eu sagittis quam.
                          <a href="#" onclick="alert('Delete Comment');"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                          <a href="#" onclick="alert('Delete Comment');"><i class="fa fa-edit" aria-hidden="true">Achieve</i></a>
                        </div>
                     </div>
